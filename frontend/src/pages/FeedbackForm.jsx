...
export default function FeedbackForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('http://localhost:3000/api/feedbacks', payload);
      ...
      <div className="bg-white shadow-lg rounded-2xl p-8 w-full max-w-2xl">
        ...
        <div className="mb-6 flex justify-center">
          <img
            ...
            alt="Banner Feedback"
            className="w-full max-w-[1584px] h-auto rounded-lg"
          />
        </div>
        ...
        {success && (
          <div className="bg-green-100 text-green-700 text-center py-2 rounded mb-4">
            {success}
          </div>
        )}
        {error && (
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="nome" className="block text-gray-700 font-semibold mb-1">
                ...
                <span className="block text-sm text-gray-500">
                  Para sabermos como te chamar e dar os devidos créditos.
                </span>
              </label>
              <input
                id="nome"
          ...
          <div>
            <label htmlFor="conteudo_avaliacao" className="block text-gray-700 font-semibold mb-1">
              ...
              <span className="block text-sm text-gray-500">
                Dica: “Pode ser sincero(a), isso nos ajuda a melhorar!”
              </span>
            </label>
            <textarea
              id="conteudo_avaliacao"
              name="conteudo_avaliacao"
              required
              className="input-style"
              value={formData.conteudo_avaliacao}
              onChange={handleChange}
            />
          </div>
  ...
  <div className="flex flex-col gap-2 mt-2">
    <label className="inline-flex items-center">
      <input
        ...
        checked={formData.baixou_curriculo === "Sim"}
        onChange={handleChange}
        required
      />
    ...
    <label className="inline-flex items-center">
      <input
        type="radio"
        name="baixou_curriculo"
        value="Ainda não, mas vou baixar"
        className="form-radio text-blue-600"
        checked={formData.baixou_curriculo === "Ainda não, mas vou baixar"}
        onChange={handleChange}
      />
      <span className="ml-2 text-gray-700">Ainda não, mas vou baixar</span>
    </label>
    ...
    <label className="inline-flex items-center">
      <input
        ...
        className="form-radio text-blue-600"
        checked={formData.baixou_curriculo === "Não tenho interesse"}
        onChange={handleChange}
      />
      <span className="ml-2 text-gray-700">Não tenho interesse</span>
    </label>
  </div>
</div>
          ...
          {isOutroTema && (
            <div className="mt-4">
              <label htmlFor="outro_tema" className="block text-gray-700 font-semibold mb-1">
                Especifique o tema:
              </label>
              <input
                id="outro_tema"
          ...
          <div>
            <label htmlFor="nota" className="block text-gray-700 font-semibold mb-1">
              ...
              <span className="block text-sm text-gray-500">
                Arraste para escolher de 1 (nunca) a 5 (com certeza)!
              </span>
            </label>
            <input
              id="nota"
          ...
          <div>
            <label htmlFor="depoimento" className="block text-gray-700 font-semibold mb-1">
              ...
              <span className="block text-sm text-gray-500">
                Dica: “Com sua permissão, podemos divulgar com seu nome e profissão.”
              </span>
            </label>
            <textarea
              id="depoimento"
          ...
          <div>
            <label htmlFor="mais_infos" className="block text-gray-700 font-semibold mb-1">
              ...
              <span className="block text-sm text-gray-500">
                Fique à vontade para se apresentar melhor, sugerir temas ou ideias!
              </span>
            </label>
            <textarea
              id="mais_infos"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-black hover:bg-blue-700 text-white font-semibold py-3 rounded-lg transition disabled:opacity-50"
          >
